...
{
    ui->lcd_damping_constant->display(mySim->myFlag->springs[0][0]->dampingConstant );
    ui->lcd_mass->display( mySim->myFlag->springs[0][0]->mass );
    ui->lcd_rest_length->display( mySim->myFlag->springs[0][0]->restLength );
    ui->lcd_spring_constant->display( mySim->myFlag->springs[0][0]->springConstant );
}

// Boxes for changing logic
void MainWindow::box_dampingConstant(double value)
{
    myopenglwidget->mySim->myFlag->springs[0][0]->dampingConstant = value;
...
{
    myopenglwidget->mySim->myFlag->springs[0][0]->restLength = value;
...
{
    myopenglwidget->mySim->myFlag->springs[0][0]->mass = value;
...
{
    myopenglwidget->mySim->myFlag->springs[0][0]->springConstant = value;
